...
The *Sargan’s test* examines the null hypothesis that the instrumental variables are not correlated with the regression error term. A significant p-value suggests that the instruments do not meet the exclusion restriction condiction. 
